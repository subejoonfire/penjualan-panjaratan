                ...
                <div>
                    ...
                    <div class="flex items-center space-x-4 text-sm text-gray-600 mb-4">
                        <span class="flex items-center">
                            ...
                            <a href="{{ route('products.category', $product->category) }}" class="text-blue-600 hover:text-blue-500">
                                {{ $product->category->category }}
                            </a>
                        </span>
                        <span class="flex items-center">
                        ...
                        <span class="flex items-center">
                            <div class="flex items-center mr-1">
                                @for($i = 1; $i <= 5; $i++)
                                <i class="fas fa-star text-xs {{ $i <= round($averageRating) ? 'text-yellow-400' : 'text-gray-300' }}"></i>
                                @endfor
                            </div>
                    ...
                    <div class="flex items-center justify-between mb-4">
                        <div>
                            <p class="text-2xl font-bold text-blue-600">Rp {{ number_format($product->productprice) }}</p>
                        </div>
