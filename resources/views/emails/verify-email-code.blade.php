...
<head>
    <meta charset="UTF-8">
    <title>Verifikasi Email - {{ env('MAIL_FROM_NAME', 'Penjualan Panjaratan') }}</title>
</head>
<body style="font-family: Arial, sans-serif; background: #f7fafc; margin:0; padding:0;">
    <div style="max-width: 480px; margin: 40px auto; background: #fff; border-radius: 8px; box-shadow: 0 2px 8px #e2e8f0; padding: 32px;">
        ...
        <p>Halo <b>{{ $name }}</b>,</p>
        <p>Terima kasih telah mendaftar di <b>{{ env('MAIL_FROM_NAME', 'Penjualan Panjaratan') }}</b>.<br>
        ...
        <p style="margin-top: 32px; color: #94a3b8; font-size: 0.9em;">&copy; {{ date('Y') }} {{ env('MAIL_FROM_NAME', 'Penjualan Panjaratan') }}</p>
    </div>
</body>
</html>