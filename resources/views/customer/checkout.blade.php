                        ...
                        <div class="p-3 sm:p-6">
                            <div class="space-y-3 sm:space-y-4">
                                ...
                                @else
                                    ...
                                    <label class="flex items-center space-x-3 cursor-pointer border rounded-lg p-2 hover:border-blue-500 transition">
                                        <input type="radio" name="payment_method" value="VA" class="text-blue-600 focus:ring-blue-500 border-gray-300" checked>
                                        <div class="flex-1">
                                    ...
                                    <label class="flex items-center space-x-3 cursor-pointer border rounded-lg p-2 hover:border-blue-500 transition">
                                        <input type="radio" name="payment_method" value="DA" class="text-blue-600 focus:ring-blue-500 border-gray-300">
                                        <div class="flex-1">
                                    ...
                                    <label class="flex items-center space-x-3 cursor-pointer border rounded-lg p-2 hover:border-blue-500 transition">
                                        <input type="radio" name="payment_method" value="OV" class="text-blue-600 focus:ring-blue-500 border-gray-300">
                                        <div class="flex-1">
