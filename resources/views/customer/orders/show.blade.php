                ...
                <div class="mt-6">
                    <div class="flex items-center">
                        ...
                        <div class="flex-1 mx-4">
                            <div class="h-0.5 {{ in_array($order->status, ['confirmed', 'shipped', 'delivered']) ? 'bg-blue-600' : 'bg-gray-300' }}"></div>
                        </div>
                        ...
                        <!-- Arrow -->
                        <div class="flex-1 mx-4">
                            <div class="h-0.5 {{ in_array($order->status, ['shipped', 'delivered']) ? 'bg-blue-600' : 'bg-gray-300' }}"></div>
                        </div>
                        ...
                        <!-- Arrow -->
                        <div class="flex-1 mx-4">
                            <div class="h-0.5 {{ $order->status === 'delivered' ? 'bg-green-600' : 'bg-gray-300' }}"></div>
                        </div>
                    ...
                    <div class="px-6 py-6">
                        <dl class="space-y-3">
                            ...
                            <div class="flex justify-between border-t border-gray-200 pt-3">
                                ...
                                <dd class="text-base font-medium text-gray-900">Rp {{ number_format($order->total_amount) }}</dd>
                            </div>
                        </dl>
                    </div>
                </div>
