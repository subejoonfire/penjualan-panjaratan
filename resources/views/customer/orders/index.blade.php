            ...
            <div class="p-6">
                <form method="GET" action="{{ route('customer.orders.index') }}" class="flex flex-wrap gap-4">
                    <div class="flex-1 min-w-64">
                        <label for="status" class="block text-sm font-medium text-gray-700 mb-2">Filter berdasarkan Status</label>
                                ...
                                <div class="flex items-center space-x-4">
                                    @if($order->cart && $order->cart->cartDetails->count() > 0)
                                        ...
                                        <div>
                                            ...
                                            <p class="text-sm text-gray-600">{{ $order->cart->cartDetails->sum('quantity') }} item</p>
                                        </div>
                                    @else
                                        <div class="flex-shrink-0">
                                            <div class="w-12 h-12 bg-gray-200 rounded-lg flex items-center justify-center">
