                ...
                <div class="block md:hidden">
                    <div class="p-4">
                        ...
                        <div class="flex items-center space-x-3 mb-3">
                            ...
                            <div class="flex-1">
                                <p class="text-sm font-medium text-gray-900">
                                    ...
                                    <span class="text-gray-500">+{{ $order->cart->cartDetails->count() - 1 }} item</span>
                                    @endif
                                </p>
                                <p class="text-xs text-gray-600">{{ $order->cart->cartDetails->sum('quantity') }} item</p>
                            </div>
                            @else
                            <div class="flex-shrink-0">
                                <div class="w-10 h-10 bg-gray-200 rounded-lg flex items-center justify-center">
                        ...
                        <div class="flex flex-col space-y-2">
                            ...
                            <button type="button" class="w-full bg-red-600 text-white px-3 py-2 rounded-md hover:bg-red-700 text-sm"
