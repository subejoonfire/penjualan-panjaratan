...
<div class="py-6">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="mt-2 text-gray-600">Kelola semua notifikasi penjual</p>
                </div>
        ...
        <div class="bg-white shadow rounded-lg mb-6">
            ...
            <div class="px-6 py-4">
                <form method="GET" action="{{ route('seller.notifications.index') }}" class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
