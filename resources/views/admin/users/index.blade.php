                ...
                <form method="GET" action="{{ route('admin.users.index') }}" class="flex flex-wrap gap-4">
                    ...
                    <div class="min-w-48">
                        ...
                        <select name="role" id="role"
                            ...
                            <option value="customer" {{ request('role')==='customer' ? 'selected' : '' }}>Pembeli
                            </option>
                        </select>
                    </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-lg font-medium text-gray-900">{{ $usersAll->count() }}</dd>
                            </dl>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-lg font-medium text-gray-900">{{ $usersAll->where('role',
                                    'customer')->count() }}</dd>
                            </dl>
                        </div>
                    </div>
