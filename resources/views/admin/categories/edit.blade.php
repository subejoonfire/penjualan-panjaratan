                ...
                <div class="px-6 py-6">
                            ...
                            <div class="flex">
                                ...
                                <div class="ml-3">
                                    ...
                                    <div class="mt-2 text-sm text-yellow-700">
                                        ...
                                        Changing the category name will affect how these products are categorized and displayed.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="bg-gray-50 border border-gray-200 rounded-md p-4 mb-6">
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                            ...
                            <div class="text-center">
                                <div class="text-2xl font-bold text-purple-600">{{ number_format($category->products()->sum('stock')) }}</div>
                                <div class="text-xs text-gray-500">Total Stock</div>
                            </div>
                            <div class="text-center">
                                <div class="text-2xl font-bold text-yellow-600">
                                    @if($category->products()->count() > 0)
                                        Rp {{ number_format($category->products()->avg('price')) }}
                                    @else
                                        -
                                    @endif
                                </div>
