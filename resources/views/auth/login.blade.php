...
<head>
    ...
    <title>Login - Penjualan Panjaratan</title>
    ...
    <div class="max-w-md w-full space-y-8 p-8">
            ...
            <div class="rounded-md shadow-sm -space-y-px">
                ...
                <div class="relative">
                    ...
                    <input id="password" name="password" type="password" autocomplete="current-password" required 
                           class="appearance-none rounded-none relative block w-full px-3 py-2 pl-10 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-b-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 focus:z-10 sm:text-sm @error('password') border-red-300 @enderror" 
            ...
            <div class="mt-6">
                ...
                <div class="mt-6 grid grid-cols-1 gap-3">
                    <div class="text-center">
                        <p class="text-xs text-gray-600 mb-2">Gunakan akun demo untuk testing:</p>
                        <div class="space-y-1 text-xs">
                            <p><strong>Admin:</strong> admin@panjaratan.com / admin123</p>
                            <p><strong>Seller:</strong> seller1@panjaratan.com / seller123</p>
                            <p><strong>Customer:</strong> customer1@panjaratan.com / customer123</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="text-center">
            <p class="text-xs text-gray-500">
                &copy; {{ date('Y') }} Penjualan Panjaratan. All rights reserved.
            </p>
        </div>
    </div>
